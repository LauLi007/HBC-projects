...
function aktivoiSeuraava(aika) {
  ...
  nappulat[nykyinen].style.backgroundColor = "darkslategray"; // muutetaan vanha harmaaksi
  nappulat[seuraava].style.backgroundColor = "orange"; // uusi oranssiksi
  ...
  function arvoUusi(edellinen) {
    ...
    var uusi = (edellinen + getRandomInt(0, 2)) % 3; //itse lisätty koodi. Arpoo randomisti pallukat. 
...
function lopetaPeli() {
    ...
    //var button = document.createElement('button'); //luodaan nappi
    ...
    // ja näytä tulos gameover-elementissä
  }
  ...
  function aloitaPeli(){
    ...
    pisteet = 0;
    document.getElementById('tulos').innerHTML = tulos;
    ajastin = setTimeout(aktivoiSeuraava, 100, vaihtoaika);
  }
